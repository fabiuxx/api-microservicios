 ...
 */
@Component
public class StockDatabaseInitializer implements DatabaseInitializer {

    private final static AppLogger log = AppLogger.get(StockDatabaseInitializer.class);
    ...
    public void init() throws Throwable {
        ...
        if (!tableExists) {
            db.createTable("app", "stock", new String[]{
